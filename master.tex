...
\section{Testing MOOGme}
\label{sec:Testing_MOOGme}
To adequate test the EW method implemented in MOOGme we derive
parameters from the sample by \citet{Sousa2008a}. We use ARES2
...
for MOOGme against those of \citet{Sousa2008a}.
...
\begin{figure}[tpb]
    ...
    to the sample by \citet{Sousa2008a}.}
